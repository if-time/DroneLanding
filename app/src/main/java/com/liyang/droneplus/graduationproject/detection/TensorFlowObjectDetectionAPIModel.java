...
//==============================================================================*/
//
//package com.liyang.droneplus.graduationproject.detection;
//
...
// * 检测图形并且绘制（规则图形矩形）
// */
//public class TensorFlowObjectDetectionAPIModel implements ClassifierFromTensorFlow {
...
//     */
//    public static ClassifierFromTensorFlow create(final AssetManager assetManager, final String modelFilename,
//                                                  final String labelFilename, final int inputSize) throws IOException {
...
//            final RectF detection = new RectF(outputLocations[4 * i + 1] * inputSize, outputLocations[4 * i] * inputSize, outputLocations[4 * i + 3] * inputSize, outputLocations[4 * i + 2] * inputSize);
