...
/**
 * Created by zh931 on 2018/8/17.
 * <p>
 * 此类来自tensorflow官网TensorFlow Android Camera Demo
 */
...
public class ImageUtils {
     ...
     * @param output        A pre-allocated array for the ARGB 8:8:8:8 output data.
     */
    private static native void convertYUV420ToARGB8888(byte[] y, byte[] u, byte[] v, int[] output, int width, int height, int yRowStride, int uvRowStride, int uvPixelStride, boolean halfSize);
     ...
     * @param height The height of the input image.
     */
    private static native void convertYUV420SPToRGB565(byte[] input, byte[] output, int width, int height);
     ...
     * @param height The height of the input image.
     */
    private static native void convertARGB8888ToYUV420SP(int[] input, byte[] output, int width, int height);
     ...
     * @param height The height of the input image.
     */
    private static native void convertRGB565ToYUV420SP(byte[] input, byte[] output, int width, int height);
     ...
     * @return
     */
    public static Bitmap rotate (Resources res, float degree) {
        Bitmap bitmap = BitmapFactory.decodeResource(res, R.mipmap.rotatedrone);
        Matrix matrix = new Matrix(); //旋转图片 动作
        matrix.setRotate((float) degree);//旋转角度
